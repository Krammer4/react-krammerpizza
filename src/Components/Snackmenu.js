...
export const SnackMenu = ({ pizzaMenuId, snacks, setSnacks, pizzas, isSigned, setIsSigned, signPls, setSignPls, myAdress, setMyAdress, cartList, setCartList, pizzaMenuShow, setPizzaMenuShow}) => {
    ...
    <div>
                ...
                <div className="pizzaMenu-info-block">
                    ...
                    <AnimatePresence>
                        ...
                        <div className="info-data-row">
                            ...
                            <p className="info-data-data">{snacks[pizzaMenuId].energy}</p>
                        </div>
                        <div className="info-data-row">
                            <p className="info-data-title">Белки</p>
                            <p className="info-data-data">{snacks[pizzaMenuId].protein}</p>
                        </div>
                        <div className="info-data-row">
                            <p className="info-data-title">Жиры</p>
                            <p className="info-data-data">{snacks[pizzaMenuId].fat}</p>
                        </div>
                        <div className="info-data-row">
                            <p className="info-data-title">Углеводы</p>
                            <p className="info-data-data">{snacks[pizzaMenuId].carbo}</p>
                        </div>
                        <div className="info-data-row">
                            <p className="info-data-title">Вес</p>
                            <p className="info-data-data">{snacks[pizzaMenuId].weight}</p>
                        </div>
        ...
        <div className="pizzaMenu-row">
            ...
            <div className="pizzaMenu-text">
                ...
                <p className="pizzaMenu-ingredients">{snacks[pizzaMenuId].ingredients}</p>
            

            

            <p onClick={()=>addToCart(pizzaMenuId)} className="pizzaMenu-addToCart">Добавить в корзину за {snacks[pizzaMenuId].minPrice} руб.</p>
            <AnimatePresence>
                {signPls && (
                    <motion.div
                    initial={{ opacity: 0 }}
