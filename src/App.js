...
function App() {
  ...
  const [snacks, setSnacks] = useState([
    ...
    },
    {
      ...
      carbo: "30.9 г",
      ingredients:
        "Насыщенный вкус колбасок чоризо и пепперони с соусами бургер и барбекю, свежими томатами, моцареллой в чиабатте",
    },
    {
    ...
    },
    {
      ...
      carbo: "30.8 г",
      ingredients:
        "Горячая закуска с цыплёнком, томатами, моцареллой, соусом ранч в тонкой пшеничной лепешке",
    },
    {
      title: "Додстер Бекон-Ветчина",
      src: baconHam,
      startPrice: 3.9,
      minPrice: 3.9,
      energy: "337 ккал",
      ...
      carbo: "31.6 г",
      ingredients:
        "Горячая закуска с ветчиной, беконом, томатами, моцареллой, соусом ранч в тонкой пшеничной лепешке",
    },
    {
      ...
      fat: "12.4 г",
      carbo: "12.5 г",
      ingredients: "Кусочки куриного филе в хрустящей панировке",
    },
    {
    ...
    {
      title: "Греческий салат с соусом бальзамик 🌱",
      src: greek,
      startPrice: 8.4,
      minPrice: 8.4,
      energy: "64.2 ккал",
    ...
    },
    {
      ...
      fat: "6.8 г",
      carbo: "34.5 г",
      ingredients: "Запеченная в печи картошечка. Привычный вкус и мало масла",
    },
    {
  ...
  const payCash = () => {
    ...
    orderTime !== ""
      ? console.log("Сделать заказ к:", orderTime)
      : console.log("Сделать заказ как можно скорее!");
  ...
  const payCard = () => {
    if (
      ...
      cardFirstDate.length == 2 &&
      cardSecDate.length == 2 &&
      cardCvv.length == 3
    ) {
      setPayOpen(false);
      setIsCartOpen(false);
      ...
      console.log(
        "Номер карты:",
        `${joinNumber[0]}${joinNumber[1]}${joinNumber[2]}${joinNumber[3]}-${joinNumber[4]}${joinNumber[5]}${joinNumber[6]}${joinNumber[7]}-${joinNumber[8]}${joinNumber[9]}${joinNumber[10]}${joinNumber[11]}-${joinNumber[12]}${joinNumber[13]}${joinNumber[14]}${joinNumber[15]}`
      );
  ...
  return (
    <div className="App">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Доставка еды на дом в Беларуси – закажите лучшие пиццы и закуски
          онлайн
        </title>
        <meta
          name="description"
          content="Быстрая доставка пиццы и закусок в Беларуси! Закажите пиццу онлайн с React pizza и насладитесь вкусными блюдами с бесплатной доставкой."
        />
      </Helmet>
      ...
      <div className="app-container">
        <Header
          ...
          phone={phone}
          setPhone={setPhone}
          yourRegPhone={yourRegPhone}
          setYourRegPhone={setYourRegPhone}
          isSigned={isSigned}
                              ...
                              <div className="order-body">
                                <div className="order-content">
                                  <img
                                    ...
                                    className="order-cross"
                                    src={cross}
                                    alt="cross"
                                    title="cross icon"
                                  />
                                  <h1 className="order-mainTitle">
                                    Оформление заказа
                                  </h1>
                                  {myAdress.length !== 0 ? (
                                    <div>
                                      ...
                                      <p className="order-myStreet">
                                        Город:{" "}
                                        <span className="order-my">
                                          {town[yourTown].title}
                                        </span>
                                      </p>
                                      {myAdress.street !== "-" && (
                                        <span>
                                          ...
                                          <p className="order-myHome">
                                            Дом{" "}
                                            <span className="order-my">
                                              {myAdress.home}
                                            </span>
                                          </p>
                                          <p className="order-myFlat">
                                            Квартира{" "}
                                            <span className="order-my">
                                              {myAdress.flat}
                                            </span>
                                    ...
                                    <div className="setAdress">
                                      <h1 className="setAdress-mainTitle">
                                        Ваш адресс:
                                      </h1>
                                      ...
                                      <button
                                        ...
                                        className="adressModal-takeMyself"
                                      >
                                        Забрать самому
                                      </button>
                                    </div>
                                ...
                                <div className="payment-content">
                                  ...
                                  <div className="pizzaMenu-type-row">
                                    {paymentType.map((item, index) => (
                                      <p
                                        onClick={() =>
                                          setPaymentTypeOnClick(index)
                                        }
                                        className={
                                          payId == index
                                            ? "pizzaMenu-type-item active"
                                            : "pizzaMenu-type-item"
                                        }
                                      >
                                        {item.title}
                                              ...
                                              >
                                                <div className="change">
                                                  <input
                                                    ...
                                                    className="change-fromWhat"
                                                    type="number"
                                                    placeholder="С какой купюры готовить сдачу?"
                                                  />
                                                </div>
                                              </motion.div>
                                            )}
                                            ...
                                            {urgentId ? (
                                              ...
                                              >
                                                <input
                                                  ...
                                                  className="change-fromWhat"
                                                  type="number"
                                                  placeholder="К какому времени доставить?"
                                                />
                                              </motion.div>
                                            ) : null}
                                          </AnimatePresence>
                                          ...
                                          <div className="card-card">
                                            ...
                                            <div className="card-info-row">
                                              ...
                                              <input
                                                value={cardSecDate}
                                                onChange={(e) =>
                                                  setCardSecDate(e.target.value)
                                                }
                                                className="card-secDate"
                                                type="number"
                                                placeholder="До"
                                              />
                                              <input
                  ...
                  <div className="success-body">
                    <div className="success-content">
                      ...
                      <div className="success-cart-card">
                          ...
                          return (
                            <div className="success-item-row">
                              <img
                                ...
                                title="success image"
                              />
                              <p className="success-cart-item-title">
                                {item.title}
                              </p>
                              <p className="success-cart-item-price">
                                {item.price} руб.
                              </p>
                            </div>
                          );
                        ...
                        <p className="success-final-price">
                          <span>Итого: </span>{" "}
                          <span>{Math.ceil(finalSumm * 100) / 100} руб.</span>
                        </p>
                        <button
                          onClick={() => finishPurchase()}
                          className="success-goBack"
                        >
                          На главную
                        </button>
                      </div>
